...
root.iconbitmap('message.png')

my_image1 = ImageTk.PhotoImage(Image.open("1.jpg"))
my_image2 = ImageTk.PhotoImage(Image.open("dn.jpeg"))
my_image3 = ImageTk.PhotoImage(Image.open("2.jpg"))
my_image4 = ImageTk.PhotoImage(Image.open("download.jpg"))
